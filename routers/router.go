...
func InitAPI() {
	...
	web.Router("/api/scan-sensitive-users", &controllers.ApiController{}, "POST:ScanSensitiveUsers")
	web.Router("/api/get-custom-properties", &controllers.ApiController{}, "GET:GetCustomProperties")
	web.Router("/api/set-custom-properties", &controllers.ApiController{}, "POST:SetCustomProperties")
	web.Router("/api/get-users-by-custom-property", &controllers.ApiController{}, "GET:GetUsersByCustomProperty")
	...
	// referral-commission (feiyu)
	web.Router("/api/get-my-referral-code", &controllers.ApiController{}, "GET:GetMyReferralCode")
	web.Router("/api/get-my-referral-stats", &controllers.ApiController{}, "GET:GetMyReferralStats")
	web.Router("/api/get-my-invitees", &controllers.ApiController{}, "GET:GetMyInvitees")
	web.Router("/api/get-my-commissions", &controllers.ApiController{}, "GET:GetMyCommissions")
	web.Router("/api/get-referral-policy", &controllers.ApiController{}, "GET:GetReferralPolicy")
	web.Router("/api/update-referral-policy", &controllers.ApiController{}, "POST:UpdateReferralPolicy")
	web.Router("/api/get-referral-rate", &controllers.ApiController{}, "GET:GetReferralRate")
	web.Router("/api/set-referral-rate", &controllers.ApiController{}, "POST:SetReferralRate")
	web.Router("/api/apply-withdrawal", &controllers.ApiController{}, "POST:ApplyWithdrawal")
	web.Router("/api/get-my-withdrawals", &controllers.ApiController{}, "GET:GetMyWithdrawals")
